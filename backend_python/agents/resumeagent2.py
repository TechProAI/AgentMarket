...
def generate_resume_html(resume_data: dict, photo_base64: Optional[str] = None) -> str:
    ...
    html = (
        ...
        "<table width='100%' style='border-collapse:collapse;width:210mm;"
        "min-height:297mm;table-layout:fixed;'>\n"
        "<colgroup><col style='width:195px;'/><col/></colgroup>\n"
        "<tr valign='top'>\n"

        # Sidebar
        "<td style='width:195px;min-height:297mm;"
        "background:#1e1b4b;"
        "padding:26px 16px;vertical-align:top;'>\n"
        + photo_html
        + "<div style='text-align:center;margin-bottom:16px;'>"
        ...
        # Main
        "<td style='padding:26px 24px;vertical-align:top;background:#fff;'>\n"
